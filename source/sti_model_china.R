sti_model_china <- function(country, mh_category, p , q, data, shock_exclude = TRUE) {
  ...
  bd_contrafact <- mh_visitsm |>  
    dplyr::select(numerator, time, tpand, To, month, China_Jan19, China_Dec20, 
